...
ENV __doozer=update BUILD_RELEASE=202409040953.p0.g1c4e745.assembly.test.el9 BUILD_VERSION=v4.18.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202409040953.p0.g1c4e745.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=microshift-bootc __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=1c4e745 OS_GIT_VERSION=4.18.0-202409040953.p0.g1c4e745.assembly.test.el9-1c4e745 SOURCE_DATE_EPOCH=1725481003 SOURCE_GIT_COMMIT=1c4e74586569e54f0169337feec6c010ec084be6 SOURCE_GIT_TAG=4.18.0-ec.0-202409020818.p0-14-g1c4e74586 SOURCE_GIT_URL=https://github.com/thegreyd/microshift 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202409040953.p0.g1c4e745.assembly.test.el9" \
